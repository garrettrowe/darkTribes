...
$(document).ready(function() {
    ...
    $('#bSubmit').click(function(e) {
        ...
        $('#bSubmit').prop('disabled', true);
        var userText = $('#conversation').html();
        if(userText.substr(0,4) !== "<div")
            setConversation(userText);
        io.emit('sendConversation', userText, id);
    });
...
function lockButtons(state){
    $('#bConA').prop('disabled', state);
    $('#bConB').prop('disabled', state);
    $('#bConC').prop('disabled', state);
    $('#bConA').removeClass("active");
    $('#bConB').removeClass("active");
    $('#bConC').removeClass("active");
}
